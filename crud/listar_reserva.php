...
?>     
	 <h1 class="text-center">Listar Reservas</h1>
      ...
      <div class="row">
		...
		</button></a><a href='index.php?link=43&id=<?php echo $linhas['id'];?>&equipamento=<?php echo $linhas['equipamento'];?>'><button type='buton' class='btn butaox btn-primary '><i class="fa fa-times-circle"></i> Excluir</button></a>
		</td>
		<?php
